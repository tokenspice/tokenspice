...
from drivers_oceanv4 import bfactory, bpool,dtfactory, globaltokens
from drivers_oceanv4 import data_token as datatoken

from util import constants 
from util.strutil import asCurrency
from web3tools import web3util, web3wallet
# from assets.ocean_py.ocean_lib.web3_internal import wallet as web3wallet
...
class AgentWallet:
    ...
    def __init__(self, USD:float=0.0, OCEAN:float=0.0, private_key=None):
        ...
        # 'message': 'Transaction gasPrice (1) is too low for the next block, 
        # which has a baseFeePerGas of 104885781'}
        self._web3wallet.fundFromAbove(num_wei=toBase18(0.01)) #magic number
