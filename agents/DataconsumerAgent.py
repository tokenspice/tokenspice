...
@enforce_types
class DataconsumerAgentV4(AgentBase.AgentBaseEvm):
    def __init__(
        self,
        name: str,
        USD: float,
    ...
    def _buyAndConsumeDT(self, state):
        ...
        # buy
        self._wallet.buyDTV4(pool, DT, DT_buy_amt, max_OCEAN_allow)
        ...
        # import ipdb
        # ipdb.set_trace()
        publisher_agent = state.agents.agentByAddress(pool_agent.minter_address)
        self._wallet.transferDT(publisher_agent._wallet, DT, DT_buy_amt)
