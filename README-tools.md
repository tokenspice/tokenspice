...
Here are some such tools, largely inspired by tools from circuit land. Each can have both a backend and frontend. A frontend with good UX can make a huge difference. 
